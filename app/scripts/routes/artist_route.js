RocknrollcallYeoman.ArtistRoute = Ember.Route.extend({
  model: function(params) {
    ...
    var url = "http://developer.echonest.com/api/v4/artist/profile?api_key=PN72ONR1LUJGV3ZKJ&format=json&bucket=biographies&bucket=blogs&bucket=familiarity&bucket=hotttnesss&bucket=images&bucket=news&bucket=reviews&bucket=terms&bucket=urls&bucket=video&bucket=id:musicbrainz",
      obj = {"id": params.enid};
